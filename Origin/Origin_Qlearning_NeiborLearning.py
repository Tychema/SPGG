...
class SPGG_Qlearning(nn.Module):
    ...
    #向四周的邻居学习经验
    def neibor_learning(self,Q_tensor):
        indices = torch.arange(L_num * L_num).view(L_num, L_num).to(device)
        #计算费米更新的概率
        indices_left,indices_right,indices_up,indices_down=self.indices_Matrix_to_Four_Matrix(indices)
        #生成一个矩阵随机决定向哪个方向学习
        ...
        Q_tensor[indices,learning_action,0]=(1-self.lr)*Q_tensor[indices,learning_action,0]+self.lr*update_neibor_learning0
        Q_tensor[indices,learning_action,1]=(1-self.lr)*Q_tensor[indices,learning_action,1]+self.lr*update_neibor_learning1
        return Q_tensor
    ...
    def updateQMatrix(self,alpha,gamma,type_t_matrix: tensor, type_t1_matrix: tensor, Q_tensor: tensor, profit_matrix: tensor):
        ...
        Q_tensor=self.neibor_learning(Q_tensor)
    ...
    def shot_pic(self,type_t_matrix: tensor,i,r):
        ...
        self.mkdir('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/two_type/generated1'.format(r))
        plt.savefig('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/two_type/generated1/t={}.png'.format(r,i))
        self.mkdir('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/two_type/generated1/type_t_matrix'.format(r))
        np.savetxt('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/two_type/generated1/type_t_matrix/{}_r={}_epoches={}_L={}_第{}次实验数据.txt'.format(str(r),"type_t_matrix",str(r),str(self.epoches),str(self.L_num),str(self.count)),type_t_matrix.cpu().numpy())
        #plt.show()
        plt.clf()
        plt.close("all")
    ...
    def shot_pic2(self,type_t_matrix: tensor,i,r):
        ...
        plt.title('Qlearning: '+f"T:{i}")
        plt.imshow(image,interpolation='None')
        self.mkdir('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/four_type/generated1'.format(r))
        plt.savefig('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/four_type/generated1/t={}.png'.format(r,i))
        self.mkdir('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/four_type/generated1/type_t_matrix'.format(r))
        np.savetxt('data/Origin_Qlearning_NeiborLearning/shot_pic/r={}/four_type/generated1/type_t_matrix/{}_r={}_epoches={}_L={}_第{}次实验数据.txt'.format(str(r),"type_t_matrix",str(r),str(self.epoches),str(self.L_num),str(self.count)),type_t_matrix.cpu().numpy())
        #plt.show()
        plt.clf()
        plt.close("all")
    #计算CD比例和利润
    ...
    def run(self,r,alpha,gamma,epsilon,epoches, L_num, device,type):
        ...
        for i in tqdm(range(epoches), desc='Processing'):
            ...
            if i==0  or i==9 or i==49 or i==99 or i==299 or i==499 or i==799 or i==999 or i==4999 or i==9999 or i==99999:
    ...
    def save_data(self,type,name,r,count,data):
        self.mkdir('data/Origin_Qlearning_NeiborLearning/'+str(type))
...
def draw_shot():
    r_list=[2.4,2.6,2.8,3.0,3.2,3.3,4.2,4.3,5.0]
    for r in r_list:
