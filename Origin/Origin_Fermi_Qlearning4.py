...
class SPGG_Qlearning(nn.Module):
    ...
    def fermiUpdate(self,type_t_minus_matrix,type_t_matrix,Q_tensor):
        ...
        updated_matrix=self.type_matrix_change(self.epsilon,type_t_matrix,Q_tensor)
        #费米更新
        left_type_t1_matrix=(learning_direction==0)*((learning_probabilities<=W_left)*indices_left+(learning_probabilities>W_left)*updated_matrix)
        right_type_t1_matrix=(learning_direction==1)*((learning_probabilities<=W_right)*indices_right+(learning_probabilities>W_right)*updated_matrix)
        up_type_t1_matrix=(learning_direction==2)*((learning_probabilities<=W_up)*indices_up+(learning_probabilities>W_up)*updated_matrix)
        down_type_t1_matrix=(learning_direction==3)*((learning_probabilities<=W_down)*indices_down+(learning_probabilities>W_down)*updated_matrix)
    ...
    def shot_pic(self,type_t_matrix: tensor,i,r):
        ...
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1'.format(r))
        plt.savefig('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/t={}.png'.format(r, i))
        #plt.show()
        plt.clf()
        plt.close("all")
    ...
    def shot_pic2(self,type_t_matrix: tensor,i,r):
        ...
        plt.title('Qlearning: '+f"T:{i}")
        plt.imshow(image,interpolation='None')
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/four_type/generated1'.format(r))
        plt.savefig('data/Origin_Fermi_Qlearning4/shot_pic/r={}/four_type/generated1/t={}.png'.format(r,i))
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/four_type/generated1/type_t_matrix'.format(r))
        torch.save(type_t_matrix.int(), 'data/Origin_Fermi_Qlearning4/shot_pic/r={}/four_type/generated1/type_t_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "type_t_matrix", str(r), str(self.epoches), str(self.L_num),str(i), str(self.count)))
        #np.savetxt('data/Origin_Fermi_Qlearning4/shot_pic/r={}/four_type/generated1/type_t_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "type_t_matrix", str(r), str(self.epoches), str(self.L_num),str(i), str(self.count)), type_t_matrix.int().cpu().numpy())
    ...
    def shot_save_data(self,type_t_minus_matrix: tensor,type_t_matrix: tensor,i,r,profit_matrix,Q_matrix):
        ...
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/type_t_matrix'.format(r))
        np.savetxt('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/type_t_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "type_t_matrix", str(r), str(self.epoches), str(self.L_num), str(i), str(self.count)),type_t_matrix.cpu().numpy())
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/profit_matrix'.format(r))
        np.savetxt('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/profit_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "profit_matrix", str(r), str(self.epoches), str(self.L_num), str(i), str(self.count)),profit_matrix.cpu().numpy())
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/Q_sa_matrix'.format(r))
        np.savetxt('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/Q_sa_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "Q_sa_matrix", str(r), str(self.epoches), str(self.L_num), str(i), str(self.count)),Q_sa_matrix.cpu().numpy())
        self.mkdir('data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/Q_matrix'.format(r))
        torch.save(Q_matrix,'data/Origin_Fermi_Qlearning4/shot_pic/r={}/two_type/generated1/Q_matrix/{}_r={}_epoches={}_L={}_T={}_第{}次实验数据.txt'.format(str(r), "Q_matrix", str(r), str(self.epoches), str(self.L_num), str(i), str(self.count)))
    ...
    def save_data(self,type,name,r,count,data):
        self.mkdir('data/Origin_Fermi_Qlearning4/'+str(type))
        np.savetxt('data/Origin_Fermi_Qlearning4/{}/{}_r={}_epoches={}_L={}_第{}次实验数据.txt'.format(str(type), name,str(r),str(self.epoches),str(self.L_num),str(count)), data)
