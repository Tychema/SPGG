...
if __name__ == '__main__':
    SPGG=SPGG_Qlearning(L_num,device,alpha,gamma,epsilon,r=4.9,epoches=10000,cal_transfer=True)
    ...
    #     self.draw_line_pic(np.arange(loop_num2)/10, D_Final_fra, C_Final_fra, np.arange(loop_num2/10), fra_yticks,r='0-5',epoches=self.epoches,type="line2",ylabel='fraction',xlable='r')
    #
