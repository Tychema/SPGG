...
class SPGG_Qlearning(nn.Module):
    ...
    def save_data(self,type,name,r,count,data):
        self.mkdir('data/Origin_Fermi_Qlearning2/heat_pic2/eta={}/gammm={}/'.format(str(self.eta),str(self.gamma))+str(type))
        np.savetxt('data/Origin_Fermi_Qlearning2/heat_pic2/eta={}/gammm={}/{}/{}_r={}_epoches={}_L={}_第{}次实验数据.txt'.format(str(self.eta),str(self.gamma),str(type), name,str(r),str(self.epoches),str(self.L_num),str(count)), data)
